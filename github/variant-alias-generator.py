#!/usr/bin/env python3
"""
Variant Alias Generator - Part of ACMG-AutoEvidence

This script converts BED files containing variant information into JSON format
with multiple alias representations for each variant, preparing them for
ACMG evidence analysis.

Usage:
    python variant-alias-generator.py <input_bed_file> [output_json_file]
